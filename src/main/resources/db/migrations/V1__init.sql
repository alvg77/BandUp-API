...
(
    ...
    user_id BIGINT NOT NULL,
    CONSTRAINT pk_disliked_posts PRIMARY KEY (post_id, user_id)
);
...
(
    post_id BIGINT NOT NULL,
    user_id BIGINT NOT NULL,
    CONSTRAINT pk_liked_posts PRIMARY KEY (post_id, user_id)
);
...
ALTER TABLE disliked_posts
    ADD CONSTRAINT fk_dispos_on_community_post FOREIGN KEY (post_id) REFERENCES community_post (id);

ALTER TABLE disliked_posts
    ADD CONSTRAINT fk_dispos_on_user FOREIGN KEY (user_id) REFERENCES "user" (id);

ALTER TABLE liked_posts
    ADD CONSTRAINT fk_likpos_on_community_post FOREIGN KEY (post_id) REFERENCES community_post (id);

ALTER TABLE liked_posts
    ADD CONSTRAINT fk_likpos_on_user FOREIGN KEY (user_id) REFERENCES "user" (id);
